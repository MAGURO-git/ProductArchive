...
<span class="badge badge--vrc">VRChat ワールド</span> コンクリートの空間にプールと居住スペースを備えた VRChat ワールド。
...
<span class="badge badge--vrc">VRChat ワールド</span> 日本の高校の教室をイメージした VRChat 向けワールド。朝・夕・夜の3シーン入り。
...
<span class="badge badge--vrc">VRChat ワールド</span> Sci-fi な部屋の VRChat 向けワールド。アバターなどを展示できる昇降機つき。
...
<span class="badge badge--vrc">VRChat ワールド</span> 高級アパートの内装の3Dモデル。VRChat のワールドとして使えます。
...
<span class="badge badge--vrc">VRChat アバター</span> PhysBone を掴んで固定すると手榴弾のエフェクトが出るアバター用ギミック。Modular Avatar 対応。
...
<span class="badge">Unity 向け3Dモデル</span> Unity 向けの無人航空機の3Dモデル。ギア格納とプロペラ回転のアニメーションつき。
...
各製品の利用条件は [利用規約](terms.md) にまとめています。
